...
class $AssetsAnimationGen {
  ...
  /// File path: assets/animation/starry-starry-night.riv
  String get starryStarryNight => 'assets/animation/starry-starry-night.riv';

  /// List of all assets
  List<String> get values => [starryStarryNight];
}
